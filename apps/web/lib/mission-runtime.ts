...
export function createV0Services(task: MonstroTask): MonstroServices {
  ...
  return {
    ...
    evaluator: { async evaluate(current, runtime, evidence) { return evaluateAcceptance(current.acceptance, runtime, evidence); } },
